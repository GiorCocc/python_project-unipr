...
1) quando la bolla colpisce il drago fare in modo che questi segua il movimento della bolla e poi venga  eliminato 
    (trovata una nuova idea, ma fuori dalla specifica - se riesci a trovare la soluzione corretta meglio)
'''
...
class Enemy(Actor):                                     #condivide molto del codice del personaggio
    ...
    def collide(self, other):
        ...
        if isinstance(other, Bubble):
            ...
            if self._lives <= 0:
                arena.remove(self)
                g2d.alert("Sei riuscito a uccidere il nemico!")
